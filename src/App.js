...
const StarIcon = ({ size = 4, opacity = 1 }) => (
  ...
  >
    <polygon
      points="8,1 9.8,6.2 15.5,6.2 11,9.4 12.8,14.7 8,11.5 3.2,14.7 5,9.4 0.5,6.2 6.2,6.2"
      fill="#f5c842"
    />
  </svg>
);
...
const Lantern = ({ side }) => (
  <motion.div
    ...
    animate={{ rotate: side === "left" ? ["-4deg", "4deg", "-4deg"] : ["4deg", "-4deg", "4deg"] }}
    transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
    transformOrigin="top center"
  >
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
      <div style={{ width: 2, height: 40, background: "linear-gradient(#c9a96e, #a07840)" }} />
      <div
        style={{
          width: 28,
          height: 44,
          background: "linear-gradient(160deg, #d4440a 0%, #f97316 50%, #fbbf24 100%)",
          borderRadius: "6px 6px 12px 12px",
          boxShadow: "0 0 18px 6px rgba(251,146,60,0.45), 0 0 8px 2px rgba(253,186,116,0.6)",
          position: "relative",
        }}
      >
        <div
      ...
      <div style={{ width: 2, height: 16, background: "#c9a96e" }} />
      <div style={{ fontSize: 10, color: "#f97316" }}>✦</div>
    </div>
  </motion.div>
);
...
export default function App() {
  ...
  const goPrev = () => setCurrentSlide((p) => (p - 1 + carouselImages.length) % carouselImages.length);
  const goNext = () => setCurrentSlide((p) => (p + 1) % carouselImages.length);
  ...
  const stagger = (i) => ({ initial: { opacity: 0, y: 28 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.15 * i, duration: 0.6, ease: [0.22, 1, 0.36, 1] } });
  ...
  return (
    <>
      ...
      <div className="page">
        ...
        <div style={{ display: "none" }} className="lanterns-desktop">
          <Lantern side="left" />
          <Lantern side="right" />
        </div>
        ...
        <main className="main">
          ...
          <motion.div style={{ textAlign: "center", marginBottom: 32 }} {...stagger(0)}>
            ...
            <motion.h1 className="title" {...stagger(1)}>
              G'azo uchun Umid
            </motion.h1>
            <motion.p className="subtitle" {...stagger(2)}>
              Birgalikda yordam uzatamiz
            </motion.p>
          </motion.div>

          {/* Main card */}
          <motion.div className="card" {...stagger(3)}>
          ...
          {/* Carousel */}
          <motion.div className="card" {...stagger(4)} style={{ padding: "20px" }}>
